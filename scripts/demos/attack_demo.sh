#!/bin/bash
# AgentOS Attack Demo - Security Scenarios
# Shows how AgentOS blocks real-world agent attack patterns
...
echo ""
echo -e "${BOLD}============================================${NC}"
echo -e "${RED}${BOLD}  AgentOS Attack Demo - Threat Scenarios${NC}"
echo -e "${BOLD}============================================${NC}"
...
run_attack \
    ...
    "git" "github.delete_repo" "AgentOS/AgentOS" "delete" "block"

run_attack \
    "Disable branch protection rules" \
    "git" "github.update_branch_protection" "AgentOS/AgentOS:main" "write" "block"

run_attack \
    "Deploy directly to production" \
    "git" "github.create_deployment" "AgentOS/AgentOS:production" "write" "review"
