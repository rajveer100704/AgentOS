...
// Used for testing AgentOS's governance pipeline with realistic data
...
const responses = {
  "github.list_repos": { content: [{ type: "text", text: JSON.stringify([
    { name: "AgentOS", full_name: "saivedant169/AgentOS", private: false, description: "Runtime governance for tool-using agents" },
  ...
  "github.create_pull_request": { content: [{ type: "text", text: JSON.stringify({
    number: 77, title: "New PR created via agent", state: "open", html_url: "https://github.com/saivedant169/AgentOS/pull/77"
  }, null, 2)}]},
  ...
  "github.create_issue": { content: [{ type: "text", text: JSON.stringify({
    number: 20, title: "New issue created via agent", state: "open", html_url: "https://github.com/saivedant169/AgentOS/issues/20"
  }, null, 2)}]},
};
