# AgentOS WASM Policy Plugin Example

Reference implementation of an AgentOS WASM policy plugin written in Go.
...
for you:
    ...
    docs/WASM_PLUGIN_GUIDE.md   -- full tutorial and ABI reference
