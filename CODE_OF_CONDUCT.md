...
This applies to all AgentOS spaces: the GitHub repo, issues, pull requests, discussions, any Discord or Slack community we set up later, and any offline events related to the project.

It also applies when you are representing AgentOS in public, for example on Twitter or at a meetup.
...
- **Preferred**: email `saivedant169@gmail.com` with the subject line `[AgentOS conduct]`
- **Alternative**: open a private GitHub security advisory (yes, that channel also works for conduct reports)
...
1. A private note asking the person to adjust their behaviour
2. A public request to adjust their behaviour
3. A temporary ban from the project spaces
4. A permanent ban from the project spaces
...
This code of conduct is based on the [Contributor Covenant 2.1](https://www.contributor-covenant.org/version/2/1/code_of_conduct/), adapted for the tone of this project. The Covenant is licensed CC BY 4.0.
