...
agentctl test-action --protocol sql --tool sql.select   --target prod   # allow
agentctl test-action --protocol sql --tool sql.drop_table --target prod # block
agentctl test-action --protocol sql --tool sql.update   --target prod   # review
```
