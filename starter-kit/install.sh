...
echo ""
echo -e "${BOLD}Installing AgentOS Governed Coding Agent Kit${NC}"
echo "================================================"
echo ""
...
echo -e "${BOLD}Building AgentOS...${NC}"
...
echo -e "${BOLD}Starting AgentOS...${NC}"
...
echo -e "${BOLD}================================================${NC}"
echo -e "${GREEN}${BOLD}AgentOS Starter Kit is running.${NC}"
echo -e "${BOLD}================================================${NC}"
echo ""
