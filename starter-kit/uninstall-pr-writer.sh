#!/usr/bin/env bash
# AgentOS PR-Writer uninstaller -- clean shutdown.
set -u
...
LOG_DIR="$PROJECT_ROOT/.AgentOS-run"

echo "Shutting down AgentOS PR-Writer..."
...
kill_pidfile "$LOG_DIR/AgentOS.pid" AgentOS
