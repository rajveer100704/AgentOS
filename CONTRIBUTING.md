...
Thank you for your interest in contributing to AgentOS. This document provides guidelines for contributing.
...
4. Register the type in `cmd/AgentOS/main.go` `initProviders()`
...
3. Add tests
4. Register in `cmd/AgentOS/main.go` `initPolicyEngine()`
